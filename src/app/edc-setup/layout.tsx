...
export const metadata: Metadata = {
  title: "Everyday Carry & Setup - Sameera Sandakelum",
  description:
  ...
  keywords:
    "edc, everyday carry, setup, pc, productivity, work, macos, macbook, windows, Sri Lanka, sameerasw, Sameera Sandakleum",
  openGraph: {
    type: "article",
    title: "Everyday Carry & Setup - Sameera Sandakelum",
    description:
