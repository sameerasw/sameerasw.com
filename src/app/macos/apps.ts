export const apps = [
  {
    ...
    imageUrl:
      "https://github.com/user-attachments/assets/1b59fa22-780b-455d-87b1-6bb028c69d37",
    price: "foss",
  },
  {
    name: "Zen Browser",
  ...
  },
  {
    ...
    description: "A native Swift macOS app for Google Tasks by me.",
    iconUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Google_Tasks_2021.svg/1200px-Google_Tasks_2021.svg.png",
    imageUrl:
      "https://github.com/user-attachments/assets/2ba5ca6e-078d-4328-96a5-e8b9455062b8",
    price: "foss",
  },
  {
    name: "Zero",
    ...
    imageUrl:
      "https://github.com/user-attachments/assets/0053365a-76c3-478b-aea5-ec8754e95c22",
    price: "foss",
  },
  {
    ...
    iconUrl: "https://karabiner-elements.pqrs.org/images/logo.png",
  ...
  },
  {
    ...
    imageUrl:
      "https://camo.githubusercontent.com/f3d8dbdf980ee1867e93b5cfdd8c643e5632c4fb35f850f41e1c03f3518797da/68747470733a2f2f69616e79682e636f6d2f616d6574687973742f696d616765732f77696e646f77732e706e67",
    price: "foss",
  },
  {
    name: "VSCode",
  ...
  },
  {
    ...
    iconUrl: "https://macmousefix.com/_ipx/w_450&q_100/mmf-icon.png",
  ...
  },
  {
    ...
    description:
      "Proton Pass is a password manager developed by the Swiss software company Proton AG. It stores login credentials, email aliases, credit card data, passkeys, 2FA secret keys, and notes in virtual vaults.",
    iconUrl: "/assets/img/articles/macos/app-screenshots/protonpass.png",
    imageUrl:
      "https://images.prismic.io/proton-me/ZpVD6B5LeNNTxKho_Frame3465630.png?auto=format%2Ccompress&fit=max",
    price: "free",
  },
  {
    name: "Ente Auth",
    ...
    description:
      "End to end encrypted open source authentication app that syncs your 2FA codes across devices on multiple platforms.",
    iconUrl:
  ...
  },
  {
    ...
    imageUrl: "/assets/img/articles/macos/app-screenshots/elmedia.png",
    price: "free",
  },
  {
    name: "Keka",
    ...
    imageUrl: "https://www.keka.io/img/demo/dock/Keka-Square-dock-b2x.png",
    price: "foss",
  },
  {
  ...
  },
  {
    ...
    description: "Menubar calendar for macOS with upcoming events",
    iconUrl:
  ...
  {
    name: "Multiviewer",
    link: "https://multiviewer.app/",
    description:
      "Stream F1 TV with multiple streams and extensive realtime data",
    iconUrl: "https://multiviewer.app/favicon.ico",
    imageUrl:
