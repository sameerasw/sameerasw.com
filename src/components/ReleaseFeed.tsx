...
const LOGO_MAP: Record<string, string> = {
  ...
  medrop: "/assets/img/project-logos/medrop-logo.svg",
              ...
              <div className="release-card-body">
                {LOGO_MAP[note.app] && (
                  note.app === "essentials" ? (
                    ...
                    <div className="release-card-logo medrop-mask" />
                  ) : note.app === "draft" ? (
            ...
            <div className="release-modal-header">
              <div className="release-modal-brand">
                {LOGO_MAP[selectedNote.app] && (
                  ...
                  ) : selectedNote.app === "medrop" ? (
                    <div className="release-modal-logo medrop-mask" />
